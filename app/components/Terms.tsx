...
const Terms = () => {
  ...
  return (
    <section id="terms" className="py-20 bg-gray-100 text-gray-900" ref={ref}>
      ...
      >
        <h2 className="text-4xl font-bold text-center mb-4 section-title-gradient font-platform-bold">
          Terms and Conditions
        </h2>
        <div className="max-w-3xl mx-auto text-left px-4 bg-white p-8 rounded-lg shadow-md">
          <ul className="list-disc list-inside space-y-5 mt-4 text-base">
            <li className="flex items-start gap-3">
              <FaUsers className="mt-1 text-blue-600 w-5 h-5" />
              <span>
            ...
            <li className="flex items-start gap-3">
              <FaShieldAlt className="mt-1 text-indigo-600 w-5 h-5" />
              <span>
            ...
            <li className="flex items-start gap-3">
              <FaExclamationTriangle className="mt-1 text-red-600 w-5 h-5" />
              <span>
            ...
            <li className="flex items-start gap-3">
              <FaMoneyBillWave className="mt-1 text-green-600 w-5 h-5" />
              <span>
            ...
            <li className="flex items-start gap-3">
              <FaBan className="mt-1 text-yellow-600 w-5 h-5" />
              <span>
